                ...
                <Container>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        ...
                        <Nav>
                            ...
                            {user ? <div className='btn btn-link text-white text-decoration-none ' onClick={handleSignOut}>Log out</div> : <Nav.Link as={Link} to="/login" className='text-white'>LogIn</Nav.Link>}
